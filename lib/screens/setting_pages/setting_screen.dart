...
import 'package:bk_bot/constant/app_color.dart';
import 'package:bk_bot/screens/home_pages/home_screen.dart';
import 'package:bk_bot/screens/setting_pages/setting_page_controller.dart';
import 'package:bk_bot/screens/setting_pages/terms_screen.dart';
              ...
              SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    isDarkMode == false || isLightMode == false
                        ? Container()
                        : Obx(() {
                            return bottomListTile(context,
                                suffix: CupertinoSwitch(
                                    value:
                                        settingPageController.isDarkMode.value,
                                    trackColor: AppColor.backGroundColor,
                                    onChanged:
                                        settingPageController.onChangeTheme),
                                onTap: () {},
                                title: "dark".tr,
                    ...
                    bottomListTile(context, suffix: Container(),
                        onTap: () async {
                      try {
                    ...
                    bottomListTile(context, suffix: Container(), onTap: () {
                      Get.to(const PrivacyScreen(),
                        ...
                        title: "privacy".tr,
                        icon: AppIcon.privacyAndPolicyIcon()),
                    33.0.addHSpace(),
                    Row(
